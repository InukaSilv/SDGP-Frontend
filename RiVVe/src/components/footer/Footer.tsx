        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Connecting students with hostel experiences Sri Lanka.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/rivvelk"
                className="text-gray-400 hover:text-blue-400 transition-colors"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a
                href="https://www.tiktok.com/@rivvelk?_t=ZS-8uZP1OvKvti&_r=1"
                className="text-gray-400 hover:text-blue-400 transition-colors"
              >
                <Music2 className="w-5 h-5" />
              </a>
              <a
                href="https://www.instagram.com/rivve_lk"
                className="text-gray-400 hover:text-blue-400 transition-colors"
              >
                <Instagram className="w-5 h-5" />
              </a>
              <a
                href="mailto:rivvelk@gmail.com"
                className="text-gray-400 hover:text-blue-400 transition-colors"
              >
          ...
          <div>
            <h4 className="text-right text-lg font-semibold text-white mb-4">
              Quick Links
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700/50">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 RiVVE. All rights reserved.
            </p>
