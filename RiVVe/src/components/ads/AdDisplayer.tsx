      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="p-5">
          <div className="flex justify-between items-start mb-3">
            <h3 className="text-xl font-bold text-gray-900">Gampaha Elite Hostel</h3>
          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-2">
              <span className="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-sm font-medium">WiFi</span>
              <span className="px-3 py-1 bg-green-100 text-green-600 rounded-full text-sm font-medium">AC</span>
            </div>
