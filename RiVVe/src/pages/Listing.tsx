...
const SAMPLE_HOSTEL = {
  ...
  description:
    "Shape eke lagai iit, hdha dhhha sdashhhdahhdshadhashdhas dgsdhagsdbas dashdhbda dghasvdsvvagd gggdga dggggsahd saggggsah dsaggghsa dgasgggdaghs dsagggdgsha dgasgdggahs dasgdhasgdhas dghasgdhsa dghasdghsgd ashdgsahdg aghsd aghsdhasd ashdgahs ghdhas",
  mapUrl:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4373.743289021465!2d79.8568296432495!3d6.875503896416942!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25bb8451ec93f%3A0xd7510c0cc08d5c2a!2sGreen%20Palace%20Colombo!5e1!3m2!1sen!2slk!4v1739990677900!5m2!1sen!2slk",
  ratingBreakdown: {
    5: 80,
    4: 30,
    3: 10,
  ...
  similarHostels: [
    {
      ...
      price: 42000,
      image:
        "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    },
    {
      id: "3",
      ...
      price: 48000,
      image:
        "https://images.unsplash.com/photo-1507089947368-19c1da9775ae?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    },
  ],
  reviewList: [
    {
      ...
      rating: 5,
      comment:
        "Amazing location and fantastic facilities! The host was incredibly helpful and made my stay memorable.",
      date: "2024-02-15",
    },
    {
      id: "2",
      ...
      rating: 4,
      comment:
        "Great value for money. The kitchen facilities were well-maintained and the WiFi was reliable.",
      date: "2024-02-10",
    },
    {
      id: "3",
      ...
      rating: 5,
      comment:
        "Perfect for long-term stays! The location is convenient and the community is very friendly.",
      date: "2024-02-01",
    },
  ],
};
          ...
          <div className="bg-gray-800 rounded-xl shadow-xl p-6 max-w-lg w-full mx-4">
            ...
            <div className="border-t border-gray-700 pt-4 mb-6">
              ...
              <p className="text-gray-300">
                Hi, I'm {host.name}! I'm a passionate host dedicated to
                providing comfortable and affordable accommodations for
                students. I believe in creating a welcoming environment where
                students can focus on their studies while feeling at home.
              </p>
            </div>
...
export default function HostelDetail() {
  ...
  const totalReviews = Object.values(hostel.ratingBreakdown).reduce(
    (a, b) => a + b,
    0
  );
