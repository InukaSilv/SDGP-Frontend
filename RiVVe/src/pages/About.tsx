...
const studentFeatures = [
  { 
    title: "Smart Search", 
    icon: "🔍", 
    description: "Search by location, price, amenities, and university proximity to find your perfect match." 
  },
  { 
  ...
  { 
    ...
    icon: "💬", 
    description: "Chat with landlords to get detailed information about hostels" 
  },
  { 
  ...
  { 
    title: "Price Alerts", 
    icon: "💲", 
    description: "Set alerts for price drops and availability at your favorite hostels." 
  },
  { 
...
const ownerFeatures = [
  ...
  { 
    ...
    icon: "🌐", 
    description: "Reach international travelers with multiple language options." 
  }
];
...
const faqItems = [
  {
    ...
    answer: "RiVVE is a student-focused hostel booking platform designed to make accommodation searches easier, safer, and more transparent."
  },
  {
    question: "How do I find hostels near my university?",
    answer: "Use our Smart Search feature to search by location and set your university as a reference point with your preferred proximity radius."
  },
  {
    question: "Are the reviews and ratings verified?",
    answer: "Yes, all reviews and ratings on RiVVE come from verified past tenants who have actually stayed at the hostels."
  },
  {
    question: "How do I contact a hostel owner or current tenant?",
    answer: "You can use our Direct Messaging feature to chat with hostel owners. For current tenants, you can request contact through our platform."
  },
  {
    question: "Can I book my hostel directly on RiVVE?",
    answer: "Yes, RiVVE provides a secure booking system that allows you to reserve your accommodation directly on our platform."
  }
];

// Animated Counter Component
const AnimatedCounter: React.FC<{ endValue: number; suffix?: string; title: string }> = ({ endValue, suffix = "", title }) => {
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 overflow-hidden min-h-screen">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <AnimatedCounter endValue={5000} suffix="+" title="Happy Students" />
            <AnimatedCounter endValue={200} suffix="+" title="Verified Hostels" />
            <AnimatedCounter endValue={15} title="Universities Covered" />
            <AnimatedCounter endValue={98} suffix="%" title="Satisfaction Rate" />
          </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-xl shadow-lg border-l-4 border-[#2772A0] transform transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300">
              ...
              and user-friendly platform. We make finding the perfect student accommodation as easy as possible.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-xl shadow-lg border-l-4 border-[#CCDDEA] transform transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300">
              ...
              bridging the gap between students and verified hostel providers while ensuring 
              safe, convenient, and affordable housing options for all.
            </p>
          </div>
        </div>
      </section>
