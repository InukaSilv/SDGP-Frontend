        ...
        <div className="absolute inset-0 bg-gradient-to-b from-gray-900/70 to-gray-900 flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto px-4">
              Get in touch with our team for any questions about our hostels or assistance with your booking
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative">
          ...
          <div className="relative bg-gray-800 rounded-2xl p-8 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center px-6 py-3 border-2 border-blue-500 rounded-lg text-base font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 group"
              >
